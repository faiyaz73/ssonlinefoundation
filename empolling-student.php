...
<div class="edu-breadcrumb-area breadcrumb-style-2 bg-image bg-image--19" style="background-image: url('https://edublink-html.devsblink.com/assets/images/bg/bg-image-19.webp');>
            <div class="container">
        ...
        <section class="why-choose-area-2 section-gap-large">
            <div class="container edublink-animated-shape">
                <div class="section-title section-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    ...
                    <h2 class="title">The Best <span class="color-secondary">Beneficial</span> Side <br> of S.S Education <span style="color:#EE4A62">Foundations</span></h2>
                    <span class="shape-line"><i class="icon-19"></i></span>
                </div>
                <div class="row g-5">
